...
-- Corrige a policy de projects sem depender de public.current_role()/current_active().
-- Use esta migration se a diretoria continuar bloqueada no INSERT mesmo apos reassert da policy.
