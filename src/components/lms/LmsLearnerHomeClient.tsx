...
export function LmsLearnerHomeClient({
  ...
  return (
    <div className="space-y-6">
      ...
      <LMSStatsCards
        cards={[
          { label: "Cursos atribuidos", value: dashboard.total, helper: "Catalogo pessoal visivel" },
          { label: "Concluidos", value: dashboard.completed, helper: "Treinamentos finalizados" },
          { label: "Em andamento", value: dashboard.inProgress, helper: "Itens que pedem retomada" },
          { label: "Vencidos", value: dashboard.overdue, helper: "Pendencias criticas" },
        ]}
      />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.25fr,0.75fr]">
            ...
            <div className="mt-5 grid gap-5 md:grid-cols-2">
              {keepLearning.length ? (
                ...
                <div className="md:col-span-2">
                  <EmptyState
                    title="Sem cursos em andamento"
                    description="Quando voce iniciar um treinamento, ele aparecera aqui para retomada rapida."
                  />
                </div>
              )}
            </div>
        ...
        <div className="space-y-6">
          <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold text-slate-950">Proximos vencimentos</h2>
              </div>
          ...
          <BattleArenaList sessions={gamification.battles} title="Arena ao vivo" subtitle="Batalhas abertas para revisao rapida e competitiva." />
        </div>
      </div>
      ...
      <section className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Recomendacoes</p>
          ...
          {recommended.length ? (
            ...
            <div className="xl:col-span-3">
              <EmptyState
                ...
                description="Quando o RH publicar novos cursos ou trilhas, eles aparecerao aqui."
              />
            </div>
          )}
        </div>
