          ...
          <div className="rounded-2xl border border-white/60 bg-white/88 px-5 py-5 shadow-[0_18px_40px_-30px_rgba(15,23,42,0.28)] backdrop-blur-md">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                aria-label={showPrivacyDetails ? "Ocultar texto de privacidade" : "Mostrar texto de privacidade"}
                title={showPrivacyDetails ? "Ocultar texto" : "Mostrar texto"}
              >
                {showPrivacyDetails ? "Fechar" : "Abrir"}
              </button>
            </div>
            <div className="mt-4">
              <Link
