...
export default function InternalSocialPage() {
  ...
  const activeShareUrl =
    activeSharePost && typeof window !== "undefined"
      ? `${window.location.origin}/share/pulsehub/${activeSharePost.id}?v=7`
      : "";
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f8fbff_0%,_#eef4ff_22%,_#f4f2ee_58%,_#f1ede6_100%)]">
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 md:px-6">
        ...
        {!searchSubmitted && activeTab === "inicio" ? (
          <main id="feed" className="mx-auto grid max-w-6xl gap-6 xl:grid-cols-[minmax(0,1fr)_320px] xl:items-start">
            <div className="space-y-6 xl:col-start-1 xl:max-w-3xl xl:justify-self-center xl:w-full">
                                      ...
                                      >
                                        <div className="flex min-w-0 items-center gap-3">
                                          <div className="h-10 w-10 shrink-0 rounded-full">
                                            {resolvePortalAvatarUrl(profile.avatar_url ?? null) ? (
                                              <div
                                                className="h-full w-full rounded-full bg-cover bg-center"
                                                style={{ backgroundImage: `url(${resolvePortalAvatarUrl(profile.avatar_url ?? null)})` }}
                                              />
                                            ) : (
                                              <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-slate-900 to-blue-700 text-xs font-semibold text-white">
                                                {initials(mentionMeta.label)}
                                              </div>
                                            )}
                                          </div>
                                          <div className="min-w-0">
                                            <p className="truncate text-sm font-semibold text-slate-900">{mentionMeta.label}</p>
                                            <p className="truncate text-xs text-slate-500">@{mentionMeta.handle}</p>
                                          </div>
                                        </div>
                          ...
                          composerMentionOptions.map((profile) => {
                            ...
                            return (
                              <button
                                ...
                                className="flex w-full items-center gap-3 rounded-2xl border border-slate-200 bg-slate-50 px-3 py-2 text-left hover:bg-slate-100"
                              >
                                <div className="h-10 w-10 shrink-0 rounded-full">
                                  {resolvePortalAvatarUrl(profile.avatar_url ?? null) ? (
                                    <div
