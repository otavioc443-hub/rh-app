    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f8fbff_0%,_#eef4ff_22%,_#f4f2ee_58%,_#f1ede6_100%)]">
      ...
      {composerExpanded ? (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-slate-950/55 px-4 py-6 backdrop-blur-sm md:items-center">
          <div className="flex max-h-[calc(100vh-3rem)] w-full max-w-2xl flex-col overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-[0_40px_120px_-36px_rgba(15,23,42,0.55)]">
            ...
            <div className="flex items-center justify-between gap-3 border-t border-slate-100 bg-white px-5 py-4">
              <button
                type="button"
                onClick={() => {
                  setComposerExpanded(false);
