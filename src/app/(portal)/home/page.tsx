  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-semibold text-slate-900">Olá, Otavio Victor</h1>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <a href="/meu-perfil/feedbacks" className="rounded-xl border border-slate-200 p-3 text-sm font-medium text-slate-800 hover:bg-slate-50">
              Feedbacks
            </a>
