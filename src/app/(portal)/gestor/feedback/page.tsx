  ...
  async function load() {
    ...
    try {
      ...
      if (cycleRes.ok) {
        ...
        setMsg("Lista de coordenadores carregada. Ciclo de feedback nao configurado ou indisponivel.");
      }
    } catch (e: unknown) {
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">Avaliacao de coordenadores com foco em resultados e lideranca.</p>
          </div>
          <button
            onClick={() => void load()}
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 space-y-6">
        ...
        <section>
          ...
          <textarea
            ...
            placeholder="Orientacao, reconhecimento e direcionamento."
          />
        </section>
